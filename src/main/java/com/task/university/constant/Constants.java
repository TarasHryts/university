...
public class Constants {
    ...
    public static final String HEAD_OF_DEPARTMENT1 = "Who is head of department";
    //Example for test2 -- Show 'Literature Department' statistic
    public static final String SHOW_STATISTIC2 = "Show";
    //Example for test3 -- Show the average salary for department 'Literature Department'
    public static final String SHOW_AVG_SALARY3 = "Show the average salary for department";
    //Example for test4 -- Show count of employee for 'Literature Department'
    public static final String SHOW_COUNT_EMPLOYEE4 = "Show count of employee for";
    //Example for test5 -- Global search by ame
    public static final String GLOBAL_SEARCH5 = "Global search by";
    // help
